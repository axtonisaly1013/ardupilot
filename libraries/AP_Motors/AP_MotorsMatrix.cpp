        ...
        case MOTOR_FRAME_OCTA:
            switch (frame_type) {
                ...
                case MOTOR_FRAME_TYPE_V:
                    ...
                    break;
                case MOTOR_FRAME_TYPE_H:
                    add_motor_raw(AP_MOTORS_MOT_1, -0.9236f,    1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  1);
                    add_motor_raw(AP_MOTORS_MOT_2,  0.9236f,    1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  5);
                    add_motor_raw(AP_MOTORS_MOT_3, -0.9236f,  0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 2);
                    add_motor_raw(AP_MOTORS_MOT_4,  0.9236f,  0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 4);
                    add_motor_raw(AP_MOTORS_MOT_5, -0.9236f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 8);
                    add_motor_raw(AP_MOTORS_MOT_6,  0.9236f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 6);
                    add_motor_raw(AP_MOTORS_MOT_7, -0.9236f,   -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  7);
                    add_motor_raw(AP_MOTORS_MOT_8,  0.9236f,   -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  3);
                    success = true;
                    break;
                default:
